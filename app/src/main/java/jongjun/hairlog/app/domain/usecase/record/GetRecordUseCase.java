...
public class GetRecordUseCase {
	...
	public Page<RecordIndexDTO> execute(Long memberId, Pageable pageable) {
	...
	public Page<RecordIndexDTO> execute(Long memberId, RecordCategory category, Pageable pageable) {
		org.springframework.data.domain.Page<RecordIndexDTO> source =
